...
<?foreach($arResult["ITEMS"] as $arItem):?>
	...
	$file_big=CFile::ResizeImageGet($arItem["PROPERTIES"]["PICTURES"]["VALUE"], Array('width'=>833, 'height'=>315),BX_RESIZE_IMAGE_EXACT,true);
?>
									...
									<div class="blog-content">
										...
										<ul class="blog-meta clearfix">
											...
											<?endif;?>
											<?if ($arItem["DISPLAY_PROPERTIES"]["HOTEL"]["VALUE"]!=""):?>
											<li>
													<?if (is_array($arItem["DISPLAY_PROPERTIES"]["HOTEL"]["DISPLAY_VALUE"])):?>
														<?=substr(implode(" - ", $arItem["DISPLAY_PROPERTIES"]["HOTEL"]["DISPLAY_VALUE"]), 0, 680) . '...';?>
													<?else:?>, 
					 									<?print_r ($arItem["DISPLAY_PROPERTIES"]["HOTEL"]["DISPLAY_VALUE"]);?>
													<?endif;?>
											</li>
											<?endif;?>
											...
											<?/*if(!empty($arItem["PROPERTIES"]["CITY_TRIP"]["VALUE"])):?>
												<li><b>Город начала поездки</b> <?=substr($arItem["DISPLAY_PROPERTIES"]["CITY_TRIP"]["DISPLAY_VALUE"]);?></li>
<?endif;*/?>
											<?if(!empty($arItem["PROPERTIES"]["DISCOUNT"]["VALUE"])):?>
												<li><b>Скидка</b> <?=$arItem["PROPERTIES"]["DISCOUNT"]["VALUE"];?> %</li>
											<?elseif(!empty($arItem["PROPERTIES"]["PRICE"]["VALUE"])):?>
												<li><b>Стоимость</b> <? echo $arItem["PROPERTIES"]["PRICE"]["VALUE"];?> <?=strip_tags($arItem["DISPLAY_PROPERTIES"]["CURRENCY"]["DISPLAY_VALUE"])?></li>
											<?endif;?>
										</ul>
										<div class="blog-entry">  
											...
											<?else:?>
													<?echo strip_tags(substr($arItem["DETAIL_TEXT"], 0, 300)) . '...';?>
											<?endif;?>
											<?/*if(!empty($arItem["PROPERTIES"]["FILE"]["VALUE"])):?>
											<br><b>Файлы для скачивания</b>
...
<?endif;*/?>										
										...
										<a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" class="btn-blog">Подробнее <i class="fa fa-long-arrow-right"></i></a>
									</div>
