...
$APPLICATION->SetTitle("Гостиницы Белоруссии 2018");
?>
    <div id="search-result-iframe-block-233"><span>Идет загрузка результатов поиска...</span></div>
    <script src="https://vetliva.ru/travelsoft.pm/assets/js/bundles/init.js"></script>
    <script>
        Travelsoft.init({
            searchResult: {
                insertion_id: "search-result-iframe-block-233",
                type: "placements",
                numberPerPage: 10,
                agent: "1094",
