...
$APPLICATION->SetTitle("Авиа туры");
?><!--BEGIN OF MODULE BLOCK--> <script type="text/javascript" language="JavaScript" src="http://tourclient.ru/f/jsboot/132059/find_tour_form?style=form-big&conf=form-index"></script> <!--END OF MODULE BLOCK--> <!--BEGIN OF MODULE BLOCK--> <script type="text/javascript" language="JavaScript" src="http://tourclient.ru/f/jsboot/132059/find_tour_offers?style=search-results&conf=default"></script> <!--END OF MODULE BLOCK--> <br>
 <br>
