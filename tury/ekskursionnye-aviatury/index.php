...
$APPLICATION->SetPageProperty("keywords", "Экскурсионные авиатуры, экскурсия, самолет");
$APPLICATION->SetPageProperty("description", "Экскурсионные авиатуры  от компании ЦЕНТРКУРОРТ. Гарантия государственного туроператора. +375 (17) 215-49-49");
$APPLICATION->SetTitle("Экскурсионные авиатуры");
?>Предлагаем Вашему вниманию экскурсионные туры с авиаперелетом.<br>
 <br>
 <img src="https://www.otpusk.by/upload/medialibrary/ef4/программы.png"><br>
 <br>
 <?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"ADD_PROPERTY_97_max" => "",
		"ADD_PROPERTY_97_min" => "",
		"ADD_PROPERTY_ID" => array("73263","73264","81537"),
 ...
 <br>
 <img width="566" src="https://www.otpusk.by/upload/medialibrary/268/Авиатуры в Израиль.png" height="137"><br>
 <br>
 <?$APPLICATION->IncludeComponent(
	"travelsoft:catalog.section",
	"seo.tours.list",
