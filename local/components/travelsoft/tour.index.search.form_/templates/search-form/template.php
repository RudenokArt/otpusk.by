	...
	<input type="hidden" value="<?= isset($arResult['countries'][$arParams['COUNTRY_FROM']]) ? $arResult['countries'][$arParams['COUNTRY_FROM']]['ti'] : -1?>" name="ti">
		...
		<span class='hide-767 tt'>Откуда</span>
			<div class="form-group">
				...
				<select style="width: 100% !important" name="ct" class="select2-multi form-control" data-placeholder="Откуда">
					<option></option>
		...
		<span class='hide-767 tt'>Куда</span>
			<div class="form-group">
				...
				<select style="width: 100% !important" name="co" class="select2-multi country form-control" data-placeholder="Куда">
					<!--<option></option>
					<?/*foreach($arResult['countries'] as $id => $val):*/?>
						<option data-ti="<?/*= $val['ti']*/?>" <?/*if($val['selected']):*/?>selected<?/*endif*/?> value="<?/*= $id*/?>"><?/*= $val['name']*/?></option>
					--><?/*endforeach*/?>
				</select>
