(function ($) {
    ...
    $(document).ready(function () {
        ...
        var isInit = false, isDatePickerClose = true;
        isPeopleContainerClose = true;
        dateContainerBus = $('.busmaster-date-container');
