...
$this->addExternalCss(SITE_TEMPLATE_PATH . "/css/icomoon_/style.min.css");
...
<div class="form-wrapper">
    <form data-json-links='<?= $arResult['JSON_LINKS_CONTAINER'] ?>'
        ...
        <div class="column-item field-date" id="date-range-container">
            <span class='tt hide-767'>Период выезда</span>
            <input value="" type="hidden" name="CheckIn" class="minDate">
            <input value="" type="hidden" name="CheckOut" class="maxDate">
            <input readonly required type="text" class="calendar-input" placeholder="Даты выезда">
        </div>
        <!--<div class="column-item">
