...
?>
<?
if(!empty($arResult["PROPERTIES"]["TITLE_H2"]["VALUE"])):
	echo "<h2>".$arResult["PROPERTIES"]["TITLE_H2"]["VALUE"]."</h2>";
endif;
?>
	...
	<?if(!empty($arResult["PROPERTIES"]["PICTURES"]["VALUE"])):?>
									...
									<div class="blog-content">
										...
										<ul class="blog-meta clearfix">
											...
											<?endif;?>
											<?if(!empty($arResult["PROPERTIES"]["PRICE"]["VALUE"])):?><li><b>Стоимость</b> <? echo $arResult["PROPERTIES"]["PRICE"]["VALUE"];?> <?=strip_tags($arResult["DISPLAY_PROPERTIES"]["CURRENCY"]["DISPLAY_VALUE"])?></li><?endif;?>
										</ul>
