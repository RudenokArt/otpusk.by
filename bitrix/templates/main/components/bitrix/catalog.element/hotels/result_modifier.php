...
//Туры
if($arParams["IBLOCK_ID"] == Set::HOTELS_IBLOCK_ID && $arParams['SECTION_ID'] == Set::SANATORII_SECTION_ID){
$arResult["hotels"] = getAdditionalElements(array("IBLOCK_ID" => Set::SPECIAL_OFF_IBLOCK_ID, 'PROPERTY_COUNTRY' => $arResult['PROPERTIES']['COUNTRY']['VALUE'], 'PROPERTY_TOWN' => $arResult['PROPERTIES']['TOWN']['VALUE'], 'ACTIVE' => 'Y', '!PROPERTY_DEPARTURE_TEXT' => ""), 3);
} 
