...
<?endif;?>
<?endif;?>
		<?if($arResult["PROPERTIES"]["MT_HOTELKEY"]['VALUE'] >= 0 && 
			!empty($arResult["PROPERTIES"]["MT_HOTELKEY"]['VALUE']) && 
			$arResult["PROPERTIES"]["NOT_SHOW_MT"]['VALUE'] != "Y"):
	         $scroll[] = array("section-1234522", "Поиск размещения");
	         ?>
		<div id="section-1234522">
		 <div class="section-title text-left">
           <h2 style="font-size: 21px">Поиск размещения</h2>
        </div>
...
<?/*endif*/?>
	...
	<?endif;?>
		<?if(!empty($arResult["SHARES"])):
            ...
            ?>
            <div class="section-title text-left">
                <h2 style="font-size: 21px">Акции</h2>
            </div>
	...
	<?$scroll[] = array("section-777", "Варианты пребывания");?>
         <div class="section-title text-left">
            <h2 style="font-size: 21px">Варианты пребывания</h2>
         </div>
	...
	?>
		<div id="section-7" class="detail-content">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Номера</h2>
			</div>
	...
	?>
		<div id="section-8" class="detail-content">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Питание</h2>
			</div>
	...
	?>
		<div id="section-9" class="detail-content">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Услуги</h2>
			</div>
	...
	?>
		<div id="section-10" class="detail-content">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Спорт и отдых</h2>
			</div>
	...
	?>
		<div id="section-11" class="detail-content">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Оздоровление</h2>
			</div>
	...
	?>
		<div id="section-12" class="detail-content">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Для детей</h2>
			</div>
	...
	?>
		<div id="section-13" class="detail-content">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Пляж</h2>
			</div>
	...
	?>
		<div id="section-14" class="detail-content">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Лечебная база</h2>
			</div>
	...
	?>
		<div id="section-09" class="detail-content">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Конференц-зал</h2>
			</div>
			<?=htmlspecialcharsBack($arResult["PROPERTIES"]["CONFERENCE_HALL"]["VALUE"]["TEXT"])?>
		</div>
	<?endif;?>
	...
	?>
		<div id="section-15" class="detail-content">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Дополнительная информация</h2>
			</div>
	...
	?>
		<div id="section-16" class="detail-content">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Информация</h2>
			</div>
	...
	?>
		<div id="section-18" class="detail-content">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Адрес</h2>
			</div>
		...
		<?if(!empty($arResult["PROPERTIES"]["HD_ADDRESS_COUNTRY_LANGUAGE"]['VALUE'])):?>
			<div class="detail-content">
				...
				<div class="section-title text-left">
					<h2 style="font-size: 21px">Адрес на языке страны пребывания</h2>
				</div>
	...
	?>
		<div id="section-30" class="detail-content">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Проезд</h2>
			</div>
			<?=htmlspecialcharsBack($arResult["PROPERTIES"]["PROEZD"]["~VALUE"]["TEXT"])?>
		</div>
	<?endif;?>
	<?if(!empty($arResult["PROPERTIES"]["PRICE_TEXT"]['VALUE'])):
		$scroll[] = array("section-38", "Цены");
	?>
		<div id="section-38" class="detail-content">

			<div class="section-title text-left">
				<h2 style="font-size: 21px"><?=(!empty($arResult["PROPERTIES"]["PRICES_TITLE"]['VALUE']))?$arResult["PROPERTIES"]["PRICES_TITLE"]['VALUE']:"Цены"?></h2>
			</div>
	...
	<?endif;?>
		...
		?>
		 <div id="section-31" class="detail-content" style="height: 400px">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Карта</h2>
			</div>
	...
	<?if($arResult['hotels']):?>
		<div id="section-3" class="detail-content">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Туры</h2>
			</div>
			<?
	...
	<?endif?>
		...
		<div class="detail-content">
			...
			<div class="section-title text-left">
				<h2 style="font-size: 21px">Смотрите также</h2>
			</div>
      ...
      <?endif?>
		...
		<?if(!empty($arResult['articles'])):?>
			...
			<div class="detail-content">
				<div class="section-title text-left">
					<h2 style="font-size: 21px">Статьи</h2>
				</div>
				<?$str = array();
...
<div class="col-sm-3 hidden-sm hidden-xs">
	...
	<div class="scrolly scrollspy-sidebar sidebar-detail" role="complementary">
		...
		onclick="ga('send','event','button','click','OrderSanat');yaCounter1028882.reachGoal('OrderSanat');yaCounter1028882.reachGoal('ostavit-zayavku-v-sanatorij',{URL: document.location.href});return true;">
			Оставить заявку
		</a>
		<script>
			$(document).ready(function(){
				if(document.location.toString().indexOf("/oteli/") != -1) {
					$("a.btn.order-btn.btn-primary").attr("onclick", "ga('send','event','button','click','BookTours');yaCounter1028882.reachGoal('BookTours');yaCounter1028882.reachGoal('ostavit-zayavku-v-otel',{URL: document.location.href});return true;");
				}
			});
		</script>
    ...
    $(document).ready(function () {
        function map_init() {
            ...
            var marker = new google.maps.Marker({
                ...
                position: {lat: <?=$arResult['point'][0][0]?>, lng: <?=$arResult['point'][0][0]?>},
                map: map,
