...
<div class="col-md-9" role="main">
    ...
    <?if(!empty($arResult['PROPERTIES']['TI_KEY']['VALUE']) && isset($arResult['city_']) && !empty($arResult['city_'])):?>
...
/*$APPLICATION->IncludeComponent(
        ...
        "inner-search-form",
        array(
        "COMPONENT_TEMPLATE" => "inner-search-form",
        "CITY_FROM" => $arResult['city_'],
        "COUNTRY_FROM" => $arResult['PROPERTIES']['TI_KEY']['VALUE'],
        "DATE_FROM" => "",
        "DATE_TO" => "",
        "NIGHT_FROM" => "7",
        "NIGHT_TO" => "14",
...
///////////////////////////////////////////////////////////////////////////////////////////
        ?>
				...
				<div style="width: 100% !important" class="tv-search-form tv-moduleid-200669"></div>
                <div class="clear"></div>
	...
	<?if(!empty($arResult['offers'])):?>
            ...
            <div id="section-5" class="detail-content">
                <div class="section-title text-left">
                    <h2 style="font-size: 21px">Специальные предложения <?=$arResult["PROPERTIES"]["CN_NAME_kuda"]["VALUE"]?> </h2>
                </div>
				<?if(!empty($arResult["PROPERTIES"]["TEXT_FOR_LINKS"]['VALUE'])):?>
				<div class="section-title text-left">
					<?print_r($arResult["PROPERTIES"]["TEXT_FOR_LINKS"]["~VALUE"]["TEXT"]);?>
				</div>
				<?endif;?>
                <div class="ajax-preloader package-list-item-wrapper on-page-result-page">
                    <?foreach($arResult['offers'] as $i): ?>
                        ...
                        <div class="package-list-item clearfix">
                            ...
                            <div class="content">
                                <span style="font-size: 17px; color: #333; margin: 18px 0 10px; display: inline-block"><a style="color: black" href="<?= $i['PAGE']?>"><?= $i["NAME"]?></a></span>
        ...
        <?if($arResult['hotels']):?>
            <div id="section-3" class="detail-content">
                <div class="section-title text-left">
                    ...
                    <?endif?>
                    <h2 style="font-size: 21px">Отели</h2>
                </div>
                <?
                $scroll[] = array("section-3", "Отели");
                ?>
        ...
        <?if($arResult['sanatorii']):?>
            <div id="section-3" class="detail-content">
                <div class="section-title text-left">
                    ...
                    <?endif?>
                    <h2 style="font-size: 21px">Санатории</h2>
                </div>
                <?
        ...
        <?if(!empty($arResult["PROPERTIES"]["CLIMATE"]['VALUE'])):
            ...
            <div id="section-21" class="detail-content ul-list">
                <div class="section-title text-left">
                    <h2 style="font-size: 21px">Климат</h2>
                </div>
        ...
        <?if(!empty($arResult["PROPERTIES"]["GEOGRAFY"]['VALUE'])):
            ...
            ?>
            <div class="section-title text-left">
                <h2 style="font-size: 21px">География</h2>
            </div>
        ...
        <?if(!empty($arResult["PROPERTIES"]["POPULATION"]['VALUE'])):
            ...
            ?>
            <div class="section-title text-left">
                <h2 style="font-size: 21px">Население</h2>
            </div>
        ...
        <?if(!empty($arResult["PROPERTIES"]["LANGUAGE"]['VALUE'])):
            ...
            ?>
            <div class="section-title text-left">
                <h2 style="font-size: 21px">Язык</h2>
            </div>
        ...
        <?if(!empty($arResult["PROPERTIES"]["KITCHEN"]['VALUE'])):
            ...
            ?>
            <div class="section-title text-left">
                <h2 style="font-size: 21px">Кухня</h2>
            </div>
        ...
        <?if($arResult['cities']):?>
            <div id="section-7" class="detail-content">
                <div class="section-title text-left">
                    <h2 style="font-size: 21px">Города <?=$arResult["PROPERTIES"]["CN_NAME_chego"]["VALUE"]?></h2>
                </div>
                <?
                            ...
                            <div class="col-sm-xss-12 col-xs-6 col-sm-4 col-md-4">
                                ...
                                <div class="hotel-item mb-1">
                                    <a style="height: 40px;" href="<?= $h['PAGE']?>">
                                        ...
                                        <div class="content">
											<span style="font-size: 14px; color: #FFF; padding: 10px; display: inline-block"><?= $h['NAME']?></span>
                                        </div>
                                    </a>
                                </div>
        ...
        <?if(!empty($arResult["PROPERTIES"]["MAP"]['VALUE']) && !empty($arResult["point"])):
            ...
            <div id="section-19" class="detail-content" style="height: 400px">
                ...
                <div class="section-title text-left">
                    <h2 style="font-size: 21px">Карта <?=$arResult["PROPERTIES"]["CN_NAME_chego"]["VALUE"]?></h2>
                </div>
