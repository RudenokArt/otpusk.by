...
<div class="sidebar-header clearfix">
	<span style="display: inline-block; font-size: 21px; color: #EB5019; margin: 0 0 12px;  font-weight: 700">ФИЛЬТР</span>
...
if(isset($arResult["ITEMS"][230]["VALUES"])):?>
	<div class="sidebar-module">
		<span style="display: inline-block; font-size: 14px; color: #333; margin-bottom: 8px;  font-weight: 700">Цена</span>
...
if(isset($arResult["ITEMS"][375]["VALUES"])):?>
	<div class="sidebar-module">
		<span style="display: inline-block; font-size: 14px; color: #333; margin-bottom: 8px;  font-weight: 700">Продолжительность <small><?if($arParams['DURATION_TITLE'] != ""): echo $arParams['DURATION_TITLE'];else:?>ночей<?endif?></small></span>
		<div class="sidebar-module-inner">
...
foreach($a as $v):
	...
	<div class="sidebar-module<?if(in_array($v[0], $arr)):?> must-show<?if($v[0] == 376):?> region<?endif?><?if(in_array($v[0], $arr_cities)):?> cities<?endif?><?endif?>" <?if(in_array($v[0], $arr) || $v[2] === 1):?>style="display: none"<?endif?> >
		...
		<span style="display: inline-block; font-size: 14px; color: #333; margin-bottom: 8px;  font-weight: 700"><?= $v[1]?></span>
		<div class="sidebar-module-inner">
...
if($arResult["ITEMS"][97]["VALUES"]):?>
	<div class="sidebar-module">
		...
		<span style="display: inline-block; font-size: 14px; color: #333; margin-bottom: 8px;  font-weight: 700">Дата начала:</span>
		<div class="sidebar-module-inner">
		<?$d = date("d.m.Y", time())?>
	...
	<div class="sidebar-module">
		<span style="display: inline-block; font-size: 14px; color: #333; margin-bottom: 8px;  font-weight: 700">Дата окончания:</span>
		<div class="sidebar-module-inner">
...
<?endif?>
 ...
 if(isset($arResult["ITEMS"][207]["VALUES"])):?>
	<div class="sidebar-module">
		...
		<span style="display: inline-block; font-size: 14px; color: #333; margin-bottom: 8px;  font-weight: 700">Тип акции</span>
		<div class="sidebar-module-inner">
		<?$f = true;
