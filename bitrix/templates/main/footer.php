					...
					<div class="row">
						...
						<div class="col-xs-12 col-sm-5 col-md-3">
							...
							<p class="footer-address"><?
								...
								?> <br><?
								// Телефоны	
								$APPLICATION->IncludeFile($SERVER["DOCUMENT_ROOT"]."/include/phone.php", Array(), Array(
								    "MODE"      => "html",        // будет редактировать в веб-редакторе
								    "NAME"      => "Телефоны",      // текст всплывающей подсказки на иконке
								    ));
...
<script>
        ...
        })(window,document,'https://bitrix.vetliva.by/upload/crm/site_button/loader_2_w2m4cj.js');
</script>
<!-- End B24 -->
     ...
     $(function(){
       ...
       setTimeout(function () {
         ...
         $sideBar.affix({
           ...
           , bottom: function () {
               return (this.bottom = $('.scrollspy-footer').outerHeight(true) + 270)
             }
           }
         })
       }, 100)
...
<script>
	...
	$(document).on('click', '.booking-form button[type="submit"]', function(event){
		...
		<?/*--a href="<?=$APPLICATION->GetCurPage()?>?special_version=Y" title="" class="topbutton"><i class="fa fa-eye-slash"></i></a--*/?>
			<style>
			.topbutton {
						width:20px;
