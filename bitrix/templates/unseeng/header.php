...
<html lang="ru" class="<?=$style?>">
	<head>
		...
		<!--<meta name="description" content="ЦентрКурорт - Версия для слабовидящих" >
...
<?endif;*/?>
		...
		<?include_once "special.php";?>
		 ...
		 <h1 class="site_name"><a href="<?=SITE_DIR?>">Республиканское унитарное предприятие ЦентрКурорт</a></h1>
<header>
