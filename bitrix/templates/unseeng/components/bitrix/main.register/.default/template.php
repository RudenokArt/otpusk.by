...
<form method="post" action="<?=POST_FORM_ACTION_URI?>" name="regform" id="register-form" style="display:none;">
	...
	<div class="modal-body pb-5">
		...
		<div class="text-center heading mt-10 mb-20" style="font-weight: 700;font-size:21px;">Регистрация</div>

		<button class="btn btn-facebook btn-block">Регистрация через Facebook</button>
		...
		<div class="form-group"> 
			<input required id="register_username" name="REGISTER[NAME]" class="form-control" type="text" placeholder="Имя пользователя"> 
		</div>
		
		<div class="form-group"> 
			<input required id="register_email" name="REGISTER[EMAIL]" class="form-control" type="email" placeholder="Email">
		</div>
		
		<div class="form-group"> 
			<input required id="register_password" name="REGISTER[PASSWORD]" class="form-control" type="password" placeholder="Пароль">
		</div>
		
		<div class="form-group"> 
			<input required id="register_password_confirm" name="REGISTER[CONFIRM_PASSWORD]" class="form-control" type="password" placeholder="Подтвердить пароль">
		</div>
	...
	<div class="modal-footer mt-10">
		...
		<div class="row gap-10">
			<div class="col-xs-6 col-sm-6 mb-10">
				...
				<input type="hidden"  value="register" name="register_submit_button"> 
			</div>
			<div class="col-xs-6 col-sm-6 mb-10">
		...
		<div class="text-left">
				У вас уже есть аккаунт? <button id="register_login_btn" type="button" class="btn btn-link">Войти</button>
		</div>
