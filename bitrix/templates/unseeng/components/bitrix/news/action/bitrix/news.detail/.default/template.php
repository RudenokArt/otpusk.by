...
<div class="blog-wrapper">
	...
	$file_big=CFile::ResizeImageGet($arResult["PROPERTIES"]["PICTURES"]["VALUE"], Array('width'=>833, 'height'=>315),BX_RESIZE_IMAGE_EXACT,true);
	?>
		<div class="blog-media">
			<?if (is_array($arResult["PROPERTIES"]["PICTURES"]["VALUE"])):?>
            ...
            <div class="row gap-1">
               ...
               <div class="col-sm-xss-12 col-xs-6 col-sm-4 col-md-4">
                  <div class="hotel-item mb-1">
                     <a href="<?= $arParams['PLACEMENT_URL'] != '' ? str_replace(array('#SITE_DIR#', '#SEF_FOLDER#', '#ELEMENT_CODE#'), array(SITE_DIR, ($h['TYPE'] == 'Cанаторий' ? 'sanatorii/' : 'oteli/'), $h['CODE']), $arParams['PLACEMENT_URL']) : $h['PAGE']?>">
                        <div class="image">
