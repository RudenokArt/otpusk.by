...
$APPLICATION->SetPageProperty("description", "Большой выбор санаториев Беларуси и за рубежом от компании ЦЕНТРКУРОРТ.");
$APPLICATION->SetPageProperty("canonical", "https://www.otpusk.by/sanatorii/");
$APPLICATION->SetPageProperty("title", "Санатории Беларуси");
